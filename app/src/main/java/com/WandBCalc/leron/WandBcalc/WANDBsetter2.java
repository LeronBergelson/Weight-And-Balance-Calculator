...
public class WANDBsetter2  extends FragmentActivity {
    savedstate2 WANDBset;
    check1 setcheck;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.wandbsetter2);
        ...
        final EditText FormulaBaggage_3 = (EditText) findViewById(R.id.FormulaBaggage3);
        final EditText FormulaBaggage_4 = (EditText) findViewById(R.id.FormulaBaggage4);
        ...
        calcbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    double FormulaBaggage3_ = Double.parseDouble(FormulaBaggage_3.getText().toString());
                    double FormulaBaggage4_ = Double.parseDouble(FormulaBaggage_4.getText().toString());
                    ...
                    WANDBset = new savedstate2(FormulaFSW1_, FormulaFSW2_, FormulaRSW1_, FormulaRSW2_, FormulaBaggage1_,
                            FormulaBaggage2_,FormulaBaggage3_,FormulaBaggage4_, FormulaFL1_, FormulaFL2_, FormulaFL3_, FormulaFL4_, FormulaSTTOC1_, FormulaSTTOC2_,
                            FormulaSFTD1_, FormulaSFTD2_, FormulaSFTD3_, FormulaCOFG1_, FormulaCOFG2_, FormulaCOFG3_);
                    setcheck = new check1(option);
                    Intent switchViewInt = new Intent(WANDBsetter2.this, MainActivity.class);
                    ...
                    Toast.makeText(WANDBsetter2.this, usertext, Toast.LENGTH_LONG).show();
                }
